// namespace: We are using the OregonH object in all different files so that we don’t pollute
// the global scope. If this object is not present, it is initialized by an empty object.
var OregonH = OregonH || {};
